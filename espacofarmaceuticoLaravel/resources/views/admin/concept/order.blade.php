...
@section('title', 'Ordenar (Conceito) | ')
        ...
        <div class="row items-push">
            ...
            <div class="col-sm-5 text-right hidden-xs">
                <ol class="breadcrumb push-10-t">
                    <li><a href="{{ route('concept') }}" class="text-orange" title="Conceito">Conceito</a></li>
                    <li>Ordenar</li>
                </ol>
            </div>
        </div>
        ...
        <div class="block">
            <div class="block-header bg-gray-darker text-white">
                <ul class="block-options">
                    <li>
                        <button type="button" class="btn-back" data-url="{{ route('concept') }}"><i class="si si-action-undo"></i></button>
                    </li>
                    <li>
                ...
                <div class="block-content block-content-full">
                    ...
                    <div class="row js-draggable-items">
                        <div class="col-sm-12 draggable-column">
                            ...
                            !!}
                            {!! Form::hidden('databaseTable', 'concept') !!}
                            {!! Form::hidden('primaryKey', 'conceptId') !!}
                            {!! Form::hidden('sortorder', '') !!}
                            @foreach($items as $item)
                                    <!-- Block -->
                            <div class="block draggable-item" title="{{ $item->conceptId }}">
                            ...
                            <div class="form-group">
                                <div class="col-xs-12 push-30-t">
                                    {!! Form::button('Concluído', ['class'=>'btn btn-primary btn-back pull-left', 'data-url'=>route('concept')]) !!}
                                </div>
                            </div>
                            {!! Form::close() !!}
                        </div>
