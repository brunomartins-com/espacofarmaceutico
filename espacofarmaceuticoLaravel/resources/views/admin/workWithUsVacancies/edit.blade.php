...
@section('title', 'Editar Vaga (Trabalhe Conosco) | ')
        ...
        <div class="block">
            ...
            <div class="block-content">
                ...
                <div class="block-content block-content-full">
                    {!! Form::open([
                        'id' => 'workWithUsVacancies',
                        'method' => 'put',
                        'class' => 'form-horizontal push-20-t',
                        'enctype' => 'multipart/form-data',
                        'url' => route('workWithUsVacanciesEditPut')
                        ])
                    !!}
                    {!! Form::hidden('workWithUsVacanciesId', $workWithUsVacancy->workWithUsVacanciesId) !!}
                    <div class="form-group">
                        <div class="col-lg-6 col-md-8 col-sm-10 col-xs-12">
                            <div class="form-input">
                                {!! Form::label('title', 'Título *') !!}
                                {!! Form::text('title', $workWithUsVacancy->title, ['class'=>'form-control', 'id'=>'title', 'maxlength'=>45]) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-10 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-input">
                                ...
                                {!! Form::textarea('details', $workWithUsVacancy->details, ['class'=>'form-control', 'id'=>'details']) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
...
$(function(){
    ...
    $('.form-horizontal').validate({
        ...
        messages: {
            ...
            'details': {
                required: 'Por favor informe os detalhes'
            }
        }
    });
});
