...
@section('title', 'Universidade Teuto | ')
        ...
        <div class="row items-push">
            <div class="col-sm-7">
                <h1 class="page-heading">
                    Universidade Teuto <small></small>
                </h1>
            </div>
            <div class="col-sm-5 text-right hidden-xs">
                <ol class="breadcrumb push-10-t">
                    <li>Universidade Teuto</li>
                    <li>Editar</li>
                </ol>
            </div>
        </div>
...
$(function(){
    ...
    $('.form-horizontal').validate({
        ...
        messages: {
            'text': {
                required: 'Informe o texto da Universidade Teuto'
            }
        }
    });
});
