...
@section('title', 'Adicionar Notícia/Release (Notícias e Releases) | ')
                    ...
                    <div class="form-group">
                        <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                            <div class="form-input">
                                ...
                                {!! Form::text('subtitle', '', ['class'=>'form-control', 'id'=>'subtitle', 'maxlength'=>240]) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-lg-10 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-input">
                                ...
                                {!! Form::textarea('tags', '', ['class'=>'form-control', 'id'=>'tags']) !!}
                            </div>
                        </div>
                    </div>
