...
@section('title', 'Editar Notícia/Release (Notícias e Releases) | ')
        ...
        <div class="row items-push">
            ...
            <div class="col-sm-5 text-right hidden-xs">
                <ol class="breadcrumb push-10-t">
                    <li><a href="{{ route('newsAndReleases') }}" class="text-orange" title="Notícias e Releases">Notícias e Releases</a></li>
                    <li>{{ $newsAndReleases->title }}</li>
                    <li>Editar</li>
                </ol>
            </div>
        </div>
        ...
        <div class="block">
            <div class="block-header bg-gray-darker text-white">
                <ul class="block-options">
                    <li>
                        <button type="button" class="btn-back" data-url="{{ route('newsAndReleases') }}"><i class="si si-action-undo"></i></button>
                    </li>
                    <li>
            ...
            <div class="block-content">
                ...
                <div class="block-content block-content-full">
                    {!! Form::open([
                        ...
                        'url' => route('newsAndReleasesEditPut')
                        ])
                    !!}
                    {!! Form::hidden('newsAndReleasesId', $newsAndReleases->newsAndReleasesId) !!}
                    <div class="form-group">
                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                            <div class="form-input">
                                {!! Form::label('date', 'Data *') !!}
                                {!! Form::text('date', $newsAndReleases->date, ['class'=>'js-datepicker js-masked-date form-control', 'data-date-format' => 'dd/mm/yyyy', 'placeholder' => 'dd/mm/yyyy', 'id'=>'date', 'maxlength'=>10]) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-6 col-md-8 col-sm-10 col-xs-12">
                            <div class="form-input">
                                ...
                                {!! Form::text('title', $newsAndReleases->title, ['class'=>'form-control', 'id'=>'title', 'maxlength'=>100]) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                            <div class="form-input">
                                ...
                                {!! Form::text('subtitle', $newsAndReleases->subtitle, ['class'=>'form-control', 'id'=>'subtitle', 'maxlength'=>240]) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-10 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-input">
                                ...
                                {!! Form::textarea('text', $newsAndReleases->text, ['class'=>'form-control', 'id'=>'text']) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-10 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-input">
                                ...
                                {!! Form::textarea('tags', $newsAndReleases->tags, ['class'=>'form-control', 'id'=>'tags']) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group image">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <label class="btn btn-primary btn-xs btn-upload" for="image" title="Selecionar Imagem">
                                ...
                                {!! Form::hidden('currentImage', $newsAndReleases->image) !!}
                    ...
                    <div class="form-group">
                        <div class="col-lg-8 col-md-10 col-sm-12 col-xs-12">
                            <div class="form-input">
                                ...
                                <p>{{ $newsAndReleases->read }} {{ 'vez' }}@if($newsAndReleases->read > 1){{ 'es' }}@endif</p>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
