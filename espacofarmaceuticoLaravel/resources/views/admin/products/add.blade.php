                    ...
                    <div class="form-group">
                        <div class="col-lg-6 col-md-8 col-sm-10 col-xs-12">
                            <div class="form-input">
                                ...
                                {!! Form::select('productsCategoriesId', $categories, '', ['id' => 'productsCategoriesId', 'class' => 'form-control']) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-6 col-md-8 col-sm-10 col-xs-12">
                            <div class="form-input">
                                ...
                                {!! Form::text('activePrinciple', '', ['class'=>'form-control', 'id'=>'activePrinciple', 'maxlength'=>200]) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-8 col-md-10 col-sm-10 col-xs-12">
                            <div class="form-input">
                                ...
                                {!! Form::textarea('presentation', '', ['class'=>'form-control', 'id'=>'presentation', 'rows' => 4]) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
