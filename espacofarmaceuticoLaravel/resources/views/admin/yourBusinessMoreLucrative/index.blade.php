...
@section('title', 'Seu Negócio + Lucrativo | ')
        ...
        <div class="row items-push">
            <div class="col-sm-7">
                <h1 class="page-heading">
                    Seu Negócio + Lucrativo <small></small>
                </h1>
            </div>
            <div class="col-sm-5 text-right hidden-xs">
                <ol class="breadcrumb push-10-t">
                    <li>Seu Negócio + Lucrativo</li>
                    <li>Editar</li>
                </ol>
            </div>
        </div>
        ...
        <div class="block">
            ...
            <div class="block-content">
                ...
                <div class="block-content block-content-full">
                    {!! Form::open([
                        'id' => 'yourBusinessMoreLucrative',
                        'method' => 'put',
                        'class' => 'form-horizontal push-20-t',
                        'enctype' => 'multipart/form-data',
                        'url' => route('yourBusinessMoreLucrativePut')
                        ])
                    !!}
...
$(function(){
    ...
    $('.form-horizontal').validate({
        ...
        messages: {
            'text': {
                required: 'Informe o texto do Seu Negócio + Lucrativo'
            }
        }
    });
});
