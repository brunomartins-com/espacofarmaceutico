...
@section('title', 'Adicionar (Legislação) | ')
        ...
        <div class="row items-push">
            ...
            <div class="col-sm-5 text-right hidden-xs">
                <ol class="breadcrumb push-10-t">
                    <li><a href="{{ route('legislation') }}" class="text-success" title="Legislação">Legislação</a></li>
                    <li>Adicionar</li>
                </ol>
            </div>
        </div>
                    ...
                    <div class="form-group">
                        <div class="col-lg-6 col-md-8 col-sm-10 col-xs-12">
                            <div class="form-input">
                                ...
                                <div class="boxSelectLegislationCategoriesId">{!! Form::select('legislationCategoriesId', $categories, '', ['id' => 'legislationCategoriesId', 'class' => 'form-control', 'style' => 'width:80%; float:left;']) !!}</div>
