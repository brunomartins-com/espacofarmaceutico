        ...
        <div class="row items-push">
            ...
            <div class="col-sm-5 text-right hidden-xs">
                <ol class="breadcrumb push-10-t">
                    <li><a href="{{ route('banners') }}" class="text-orange" title="Banners">Banners</a></li>
                    <li>{{ $banner->title }}</li>
                    <li>Editar</li>
                </ol>
            </div>
                    ...
                    <div class="form-group">
                        <div class="col-lg-6 col-md-8 col-sm-10 col-xs-12">
                            <div class="form-input">
                                ...
                                {!! Form::text('subtitle', $banner->subtitle, ['class'=>'form-control', 'id'=>'subtitle', 'maxlength'=>100]) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-6 col-md-8 col-sm-10 col-xs-12">
                            <div class="form-input">
                                {!! Form::label('url', 'Link') !!}
                                {!! Form::text('url', $banner->url, ['class'=>'form-control', 'id'=>'url', 'maxlength'=>255]) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-2 col-md-4 col-sm-8 col-xs-10">
                            <div class="form-input">
                                ...
                                <select name="target" id="target" class="form-control">
                                    ...
                                    <option value="_self" @if($banner->target == '_self'){{ 'selected' }}@endif>Mesma Janela</option>
                                    <option value="_blank" @if($banner->target == '_blank'){{ 'selected' }}@endif>Nova Janela</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    <div class="form-group image">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="img-current">
                                <img src="{!! url($imageDetails['folder'].$banner->image)."?".time() !!}" alt="{{ $banner->title }}" class="img-responsive" />
                            </div>
