                    ...
                    <div class="form-group">
                        <div class="col-lg-6 col-md-8 col-sm-10 col-xs-12">
                            <div class="form-input">
                                ...
                                {!! Form::text('subtitle', '', ['class'=>'form-control', 'id'=>'subtitle', 'maxlength'=>100]) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group image">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="img-current">
                                <img src="http://placehold.it/{{ $imageDetails['imageWidth'] }}x{{ $imageDetails['imageHeight'] }}" alt="Adicionar Banner" class="img-responsive" />
                            </div>
