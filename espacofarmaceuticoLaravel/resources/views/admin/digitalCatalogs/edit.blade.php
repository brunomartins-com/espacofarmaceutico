        ...
        <div class="row items-push">
            ...
            <div class="col-sm-5 text-right hidden-xs">
                <ol class="breadcrumb push-10-t">
                    <li><a href="{{ route('digitalCatalogs') }}" class="text-orange" title="Catálogos Digitais">Catálogos Digitais</a></li>
                    <li>{{ $digitalCatalogs->title }}</li>
                    <li>Editar</li>
                </ol>
            </div>
        </div>
            ...
            <div class="block-content">
                ...
                <div class="block-content block-content-full">
                    {!! Form::open([
                        ...
                        'url' => route('digitalCatalogsEditPut')
                        ])
                    !!}
                    {!! Form::hidden('digitalCatalogsId', $digitalCatalogs->digitalCatalogsId) !!}
                    <div class="form-group">
                        <div class="col-lg-6 col-md-8 col-sm-10 col-xs-12">
                            <div class="form-input">
                                {!! Form::label('title', 'Título *') !!}
                                {!! Form::text('title', $digitalCatalogs->title, ['class'=>'form-control', 'id'=>'title', 'maxlength'=>45]) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-10 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-input">
                                ...
                                {!! Form::textarea('embed', $digitalCatalogs->embed, ['class'=>'form-control', 'id'=>'embed']) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
