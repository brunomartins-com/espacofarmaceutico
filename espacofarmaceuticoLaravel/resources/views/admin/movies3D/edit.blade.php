            ...
            <div class="block-content">
                ...
                <div class="block-content block-content-full">
                    {!! Form::open([
                        ...
                        'url' => route('movies3DEditPut')
                        ])
                    !!}
                    {!! Form::hidden('movies3DId', $movies3D->movies3DId) !!}
                    <div class="form-group">
                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                            <div class="form-input">
                                {!! Form::label('date', 'Data *') !!}
                                {!! Form::text('date', $movies3D->date, ['class'=>'js-datepicker js-masked-date form-control', 'data-date-format' => 'dd/mm/yyyy', 'placeholder' => 'dd/mm/yyyy', 'id'=>'date', 'maxlength'=>10]) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-6 col-md-8 col-sm-10 col-xs-12">
                            <div class="form-input">
                                ...
                                {!! Form::text('title', $movies3D->title, ['class'=>'form-control', 'id'=>'title', 'maxlength'=>100]) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-10 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-input">
                                ...
                                {!! Form::textarea('description', $movies3D->description, ['class'=>'form-control', 'id'=>'description']) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-8 col-md-10 col-sm-12 col-xs-12">
                            <div class="form-input">
                                ...
                                {!! Form::text('url', $movies3D->url, ['class'=>'form-control', 'id'=>'url', 'placeholder'=>'http://', 'maxlength'=>255]) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group image">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="img-current">
                                <img src="{!! url($imageDetails['folder'].$movies3D->image)."?".time() !!}" alt="{{ $movies3D->title }}" class="img-responsive" />
                            </div>
                            ...
                            <label class="btn btn-primary btn-xs btn-upload" for="image" title="Selecionar Imagem">
                                ...
                                {!! Form::hidden('currentImage', $movies3D->image) !!}
                    ...
                    <div class="form-group">
                        <div class="col-lg-8 col-md-10 col-sm-12 col-xs-12">
                            <div class="form-input">
                                {!! Form::label('', 'Esse vídeo foi visto') !!}
                                <p>{{ $movies3D->watch }} {{ 'vez' }}@if($movies3D->watch > 1){{ 'es' }}@endif</p>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
