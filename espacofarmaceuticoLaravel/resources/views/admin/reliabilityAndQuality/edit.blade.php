...
@section('title', 'Editar (Confiabilidade e Qualidade) | ')
        ...
        <div class="row items-push">
            ...
            <div class="col-sm-5 text-right hidden-xs">
                <ol class="breadcrumb push-10-t">
                    ...
                    <li>{{ $reliabilityAndQuality->title }}</li>
                    <li>Editar</li>
                </ol>
            </div>
        </div>
        ...
        <div class="block">
            ...
            <div class="block-content">
                ...
                <div class="block-content block-content-full">
                    {!! Form::open([
                        'id' => 'reliabilityAndQuality',
                        'method' => 'put',
                        'class' => 'form-horizontal push-20-t',
                        'enctype' => 'multipart/form-data',
                        'url' => route('reliabilityAndQualityEditPut')
                        ])
                    !!}
                    {!! Form::hidden('reliabilityAndQualityId', $reliabilityAndQuality->reliabilityAndQualityId) !!}
                    <div class="form-group">
                        <div class="col-lg-6 col-md-8 col-sm-10 col-xs-12">
                            <div class="form-input">
                                {!! Form::label('title', 'Título *') !!}
                                {!! Form::text('title', $reliabilityAndQuality->title, ['class'=>'form-control', 'id'=>'title', 'maxlength'=>45]) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-10 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-input">
                                ...
                                {!! Form::textarea('text', $reliabilityAndQuality->text, ['class'=>'form-control', 'id'=>'text']) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
