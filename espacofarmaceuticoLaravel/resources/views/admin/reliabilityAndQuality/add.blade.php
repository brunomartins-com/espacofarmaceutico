...
@section('title', 'Adicionar (Confiabilidade e Qualidade) | ')
        ...
        <div class="row items-push">
            ...
            <div class="col-sm-5 text-right hidden-xs">
                <ol class="breadcrumb push-10-t">
                    <li><a href="{{ route('reliabilityAndQuality') }}" class="text-success" title="Confiabilidade e Qualidade">Confiabilidade e Qualidade</a></li>
                    <li>Adicionar</li>
                </ol>
            </div>
        </div>
            ...
            <div class="block-content">
                ...
                <div class="block-content block-content-full">
                    {!! Form::open([
                        ...
                        'url' => route('reliabilityAndQualityAdd')
                        ])
                    !!}
