...
@section('title', 'Confiabilidade e Qualidade | ')
        ...
        <div class="row items-push">
            ...
            <div class="col-sm-5 text-right hidden-xs">
                <ol class="breadcrumb push-10-t">
                    <li>Confiabilidade e Qualidade</li>
                    <li>Lista</li>
                </ol>
            </div>
        </div>
        ...
        <div class="block">
            <div class="block-header bg-gray-lighter">
                ...
                <h3 class="block-title">
                    {!! Form::button('<i class="fa fa-plus"></i> Adicionar', ['class'=>'btn btn-primary', 'onclick'=>'window.open(\''.route('reliabilityAndQualityAdd').'\', \'_self\');']) !!}
                    {!! Form::button('<i class="fa fa-list"></i> Ordenar', ['class'=>'btn btn-warning push-10-l', 'onclick'=>'window.open(\''.route('reliabilityAndQualityOrder').'\', \'_self\');']) !!}
                </h3>
            </div>
            <div class="block-content">
                ...
                <table class="table table-bordered table-striped js-dataTable-full">
                    ...
                    <tbody>
                    @foreach($reliabilityAndQuality as $text)
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                'onclick'=>'window.open(\''.route('reliabilityAndQualityEdit', $text->reliabilityAndQualityId).'\', \'_self\')']) !!}

                                {!! Form::open([
                                    'id' => 'textDelete'.$text->reliabilityAndQualityId,
                                    'method' => 'delete',
                                    'enctype' => 'multipart/form-data',
                                    'url' => ''
                                    ])
                                !!}
                                {!! Form::hidden('reliabilityAndQualityId', $text->reliabilityAndQualityId) !!}
                                {!! Form::button('<i class="fa fa-trash"></i>', ['title'=>'Excluir', 'data-toggle'=>'tooltip', 'class'=>'btn btn-xs btn-danger btn-delete',
                                'data-url'=>route('reliabilityAndQualityDelete'), 'data-form'=>true, 'data-id-form'=>'textDelete'.$text->reliabilityAndQualityId]) !!}
                                {!! Form::close() !!}
                            </td>
                        </tr>
                    @endforeach
