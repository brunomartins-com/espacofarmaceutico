...
@section('title', 'Adicionar Aplicativo | ')
        ...
        <div class="row items-push">
            ...
            <div class="col-sm-5 text-right hidden-xs">
                <ol class="breadcrumb push-10-t">
                    <li><a href="{{ route('apps') }}" class="text-success" title="Aplicativos">Aplicativos</a></li>
                    <li>Adicionar</li>
                </ol>
            </div>
        </div>
                    ...
                    <div class="form-group">
                        <div class="col-lg-6 col-md-8 col-sm-10 col-xs-12">
                            <div class="form-input">
                                ...
                                {!! Form::text('iphoneUrl', '', ['class'=>'form-control', 'id'=>'iphoneUrl', 'placeholder'=>'http://', 'maxlength'=>255]) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-6 col-md-8 col-sm-10 col-xs-12">
                            <div class="form-input">
                                ...
                                {!! Form::text('ipadUrl', '', ['class'=>'form-control', 'id'=>'ipadUrl', 'placeholder'=>'http://', 'maxlength'=>255]) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-6 col-md-8 col-sm-10 col-xs-12">
                            <div class="form-input">
                                ...
                                {!! Form::text('androidUrl', '', ['class'=>'form-control', 'id'=>'androidUrl', 'placeholder'=>'http://', 'maxlength'=>255]) !!}
                            </div>
                        </div>
                    </div>
...
$(function(){
    ...
    $('.form-horizontal').validate({
        ...
        messages: {
            ...
            'image': {
                required: 'Por favor faça o upload da imagem'
            }
        }
    });
});
