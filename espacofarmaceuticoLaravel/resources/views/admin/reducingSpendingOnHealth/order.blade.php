...
@section('title', 'Ordenar (Redução Gastos c/ Saúde) | ')
                ...
                <div class="block-content block-content-full">
                    ...
                    <div class="row js-draggable-items">
                        <div class="col-sm-12 draggable-column">
                            ...
                            !!}
                            {!! Form::hidden('databaseTable', 'reducingSpendingOnHealth') !!}
                            {!! Form::hidden('primaryKey', 'reducingSpendingOnHealthId') !!}
                            {!! Form::hidden('sortorder', '') !!}
                            @foreach($items as $item)
                                    <!-- Block -->
                            <div class="block draggable-item" title="{{ $item->reducingSpendingOnHealthId }}">
                            ...
                            <div class="form-group">
                                <div class="col-xs-12 push-30-t">
                                    {!! Form::button('Concluído', ['class'=>'btn btn-primary btn-back pull-left', 'data-url'=>route('reducingSpendingOnHealth')]) !!}
                                </div>
                            </div>
                            {!! Form::close() !!}
                        </div>
