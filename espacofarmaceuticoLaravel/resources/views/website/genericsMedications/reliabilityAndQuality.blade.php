...
@section('title')
{{ "Confiabilidade e Qualidade (".$pages->title.") - " }}
@stop
        ...
        <aside class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <nav class="sidebar-menu">
                <ul>
                    ...
                    <li><a href="{{ url('medicamentos-genericos/confiabilidade-e-qualidade') }}" class="active" title="Confiabilidade e Qualidade">Confiabilidade e Qualidade</a></li>
                </ul>
            </nav>
        </aside>
