...
@section('title')
{{ "Perguntas Frequentes (".$pages->title.") - " }}
@stop
    ...
    <section class="col-lg-10 col-lg-offset-1 col-md-12 col-md-offset-0 col-sm-12 col-xs-12 text-page">
        ...
        <aside class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <nav class="sidebar-menu">
                <ul>
                    <li><a href="{{ url('medicamentos-genericos/perguntas-frequentes') }}" class="active" title="Perguntas Frequentes">Perguntas Frequentes</a></li>
                    <li><a href="{{ url('medicamentos-genericos/conceito') }}" title="Conceito">Conceito</a></li>
                    <li><a href="{{ url('medicamentos-genericos/reducao-dos-gastos-com-a-saude') }}" title="Redução dos gastos com a saúde">Redução dos gastos com a saúde</a></li>
        ...
        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
            ...
            <article class="text">
                <h4>{{ $text->sortorder }} | {{ $text->question }}</h4>
                {!! $text->answer !!}
            </article>
            @endforeach
        </div>
