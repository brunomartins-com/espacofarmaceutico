    ...
    <section class="col-lg-10 col-lg-offset-1 col-md-12 col-md-offset-0 col-sm-12 col-xs-12 text-page">
        ...
        <aside class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <nav class="sidebar-menu">
                <ul>
                    ...
                    <li><a href="{{ url('medicamentos-genericos/legislacao') }}" class="active" title="Legislação">Legislação</a></li>
        ...
        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
            ...
            <article class="text">
                ...
                @foreach($category->legislations as $legislation)
